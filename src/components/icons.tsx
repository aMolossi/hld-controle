...
export const IconDashboard = ({ size = 19 }: P) => (
  <svg {...base(size)}>
...
export const IconCart = ({ size = 19 }: P) => (
  <svg {...base(size)}>
...
export const IconWallet = ({ size = 19 }: P) => (
  <svg {...base(size)}>
...
export const IconMoney = ({ size = 15 }: P) => (
  <svg {...base(size)}>
    <circle cx="12" cy="12" r="9" />
    <path d="M12 7v10M9.5 9.5a2.5 2 0 0 1 5 0c0 1.5-2.5 1.5-2.5 2.5M9.5 14.5a2.5 2 0 0 0 5 0" />
  </svg>
);
